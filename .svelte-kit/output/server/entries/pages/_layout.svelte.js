...
const Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<nav class="bg-white dark:bg-gray-800 shadow-lg sticky top-0 z-50"><div class="container mx-auto px-4"><div class="flex items-center justify-between h-16"> <div class="flex items-center gap-8"><a href="/" class="flex items-center gap-2 hover:opacity-80 transition-opacity" aria-label="DiplomMap Home">${validate_component(Newspaper, "Newspaper").$$render(
    ...
    true
  ) + " svelte-4aqlqm"}">${validate_component(Trending_up, "TrendingUp").$$render($$result, { class: "w-4 h-4" }, {}, {})} <span data-svelte-h="svelte-1nh06tc">Top Stories</span></a> <a href="/markets" class="${"nav-link " + escape(
    isActive("/markets") ? "text-blue-600 dark:text-blue-400" : "",
    true
  ) + " svelte-4aqlqm"}">${validate_component(Bar_chart_2, "BarChart2").$$render($$result, { class: "w-4 h-4" }, {}, {})} <span data-svelte-h="svelte-i5z6ph">Markets</span></a> <a href="/saved" class="${"nav-link " + escape(
    isActive("/saved") ? "text-blue-600 dark:text-blue-400" : "",
    true
  ) + " svelte-4aqlqm"}">${validate_component(Bookmark, "Bookmark").$$render($$result, { class: "w-4 h-4" }, {}, {})} <span data-svelte-h="svelte-7f40kr">Saved</span></a> <a href="/conflicts" class="${"flex items-center gap-2 px-3 py-1.5 rounded-full " + escape(
...
const css$1 = {
  code: ".social-link.svelte-b1jbhb{border-radius:9999px;--tw-bg-opacity:1;background-color:rgb(243 244 246 / var(--tw-bg-opacity, 1));padding:0.5rem;transition-property:color, background-color, border-color, text-decoration-color, fill, stroke;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);transition-duration:150ms\n}.social-link.svelte-b1jbhb:hover{--tw-bg-opacity:1;background-color:rgb(219 234 254 / var(--tw-bg-opacity, 1))\n}.social-link.svelte-b1jbhb:is(.dark *){--tw-bg-opacity:1;background-color:rgb(55 65 81 / var(--tw-bg-opacity, 1))\n}.social-link.svelte-b1jbhb:hover:is(.dark *){--tw-bg-opacity:1;background-color:rgb(30 58 138 / var(--tw-bg-opacity, 1))\n}.footer-link.svelte-b1jbhb{--tw-text-opacity:1;color:rgb(75 85 99 / var(--tw-text-opacity, 1));transition-property:color, background-color, border-color, text-decoration-color, fill, stroke;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);transition-duration:150ms\n}.footer-link.svelte-b1jbhb:hover{--tw-text-opacity:1;color:rgb(37 99 235 / var(--tw-text-opacity, 1))\n}.footer-link.svelte-b1jbhb:is(.dark *){--tw-text-opacity:1;color:rgb(156 163 175 / var(--tw-text-opacity, 1))\n}.footer-link.svelte-b1jbhb:hover:is(.dark *){--tw-text-opacity:1;color:rgb(96 165 250 / var(--tw-text-opacity, 1))\n}",
  map: '{"version":3,"file":"Footer.svelte","sources":["Footer.svelte"],"sourcesContent":["<script lang=\\"ts\\">import {\\n  Newspaper,\\n  Twitter,\\n  Facebook,\\n  Instagram,\\n  Linkedin,\\n  Mail\\n} from \\"lucide-svelte\\";\\n<\/script>\\n\\n<footer class=\\"bg-white dark:bg-gray-800 shadow-lg mt-auto\\">\\n  <div class=\\"container mx-auto px-4 py-8\\">\\n    <div class=\\"grid grid-cols-1 md:grid-cols-4 gap-8\\">\\n      <!-- Brand -->\\n      <div class=\\"space-y-4\\">\\n        <div class=\\"flex items-center gap-2\\">\\n          <Newspaper class=\\"w-8 h-8 text-blue-600 dark:text-blue-400\\" />\\n          <span class=\\"text-xl font-bold\\">DiplomMap</span>\\n        </div>\\n        <p class=\\"text-sm text-gray-600 dark:text-gray-400\\">\\n          Your comprehensive source for global news, conflicts, and geopolitical insights.\\n        </p>\\n        <div class=\\"flex gap-4\\">\\n          <a href=\\"#\\" class=\\"social-link\\">\\n            <Twitter class=\\"w-5 h-5\\" />\\n          </a>\\n          <a href=\\"#\\" class=\\"social-link\\">\\n            <Facebook class=\\"w-5 h-5\\" />\\n          </a>\\n          <a href=\\"#\\" class=\\"social-link\\">\\n            <Instagram class=\\"w-5 h-5\\" />\\n          </a>\\n          <a href=\\"#\\" class=\\"social-link\\">\\n            <Linkedin class=\\"w-5 h-5\\" />\\n          </a>\\n        </div>\\n      </div>\\n\\n      <!-- Quick Links -->\\n      <div>\\n        <h3 class=\\"font-semibold mb-4\\">Quick Links</h3>\\n        <ul class=\\"space-y-2\\">\\n          <li><a href=\\"#\\" class=\\"footer-link\\">Top Stories</a></li>\\n          <li><a href=\\"#\\" class=\\"footer-link\\">Global Conflicts</a></li>\\n          <li><a href=\\"#\\" class=\\"footer-link\\">Elections</a></li>\\n          <li><a href=\\"#\\" class=\\"footer-link\\">Markets</a></li>\\n        </ul>\\n      </div>\\n\\n      <!-- Categories -->\\n      <div>\\n        <h3 class=\\"font-semibold mb-4\\">Categories</h3>\\n        <ul class=\\"space-y-2\\">\\n          <li><a href=\\"#\\" class=\\"footer-link\\">World News</a></li>\\n          <li><a href=\\"#\\" class=\\"footer-link\\">India</a></li>\\n          <li><a href=\\"#\\" class=\\"footer-link\\">Business</a></li>\\n          <li><a href=\\"#\\" class=\\"footer-link\\">Technology</a></li>\\n          <li><a href=\\"#\\" class=\\"footer-link\\">Sports</a></li>\\n        </ul>\\n      </div>\\n\\n      <!-- Newsletter -->\\n      <div>\\n        <h3 class=\\"font-semibold mb-4\\">Stay Updated</h3>\\n        <p class=\\"text-sm text-gray-600 dark:text-gray-400 mb-4\\">\\n          Subscribe to our newsletter for daily updates.\\n        </p>\\n        <div class=\\"flex\\">\\n          <input\\n            type=\\"email\\"\\n            placeholder=\\"Enter your email\\"\\n            class=\\"flex-1 px-4 py-2 rounded-l-lg border dark:border-gray-700 bg-gray-50 dark:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500\\"\\n          />\\n          <button class=\\"px-4 py-2 bg-blue-600 text-white rounded-r-lg hover:bg-blue-700 transition-colors\\">\\n            <Mail class=\\"w-5 h-5\\" />\\n          </button>\\n        </div>\\n      </div>\\n    </div>\\n\\n    <div class=\\"border-t dark:border-gray-700 mt-8 pt-8 text-center text-sm text-gray-600 dark:text-gray-400\\">\\n      <p>© {new Date().getFullYear()} DiplomMap. All rights reserved.</p>\\n    </div>\\n  </div>\\n</footer>\\n\\n<style lang=\\"postcss\\">\\n  .social-link {\\n\\n    border-radius: 9999px;\\n\\n    --tw-bg-opacity: 1;\\n\\n    background-color: rgb(243 244 246 / var(--tw-bg-opacity, 1));\\n\\n    padding: 0.5rem;\\n\\n    transition-property: color, background-color, border-color, text-decoration-color, fill, stroke;\\n\\n    transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1);\\n\\n    transition-duration: 150ms\\n}\\n\\n.social-link:hover {\\n\\n    --tw-bg-opacity: 1;\\n\\n    background-color: rgb(219 234 254 / var(--tw-bg-opacity, 1))\\n}\\n\\n.social-link:is(.dark *) {\\n\\n    --tw-bg-opacity: 1;\\n\\n    background-color: rgb(55 65 81 / var(--tw-bg-opacity, 1))\\n}\\n\\n.social-link:hover:is(.dark *) {\\n\\n    --tw-bg-opacity: 1;\\n\\n    background-color: rgb(30 58 138 / var(--tw-bg-opacity, 1))\\n}\\n\\n  .footer-link {\\n\\n    --tw-text-opacity: 1;\\n\\n    color: rgb(75 85 99 / var(--tw-text-opacity, 1));\\n\\n    transition-property: color, background-color, border-color, text-decoration-color, fill, stroke;\\n\\n    transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1);\\n\\n    transition-duration: 150ms\\n}\\n\\n  .footer-link:hover {\\n\\n    --tw-text-opacity: 1;\\n\\n    color: rgb(37 99 235 / var(--tw-text-opacity, 1))\\n}\\n\\n  .footer-link:is(.dark *) {\\n\\n    --tw-text-opacity: 1;\\n\\n    color: rgb(156 163 175 / var(--tw-text-opacity, 1))\\n}\\n\\n  .footer-link:hover:is(.dark *) {\\n\\n    --tw-text-opacity: 1;\\n\\n    color: rgb(96 165 250 / var(--tw-text-opacity, 1))\\n}\\n</style>"],"names":[],"mappings":"AAuFE,0BAAa,CAEX,aAAa,CAAE,MAAM,CAErB,eAAe,CAAE,CAAC,CAElB,gBAAgB,CAAE,IAAI,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,CAAC,CAAC,IAAI,eAAe,CAAC,EAAE,CAAC,CAAC,CAE5D,OAAO,CAAE,MAAM,CAEf,mBAAmB,CAAE,KAAK,CAAC,CAAC,gBAAgB,CAAC,CAAC,YAAY,CAAC,CAAC,qBAAqB,CAAC,CAAC,IAAI,CAAC,CAAC,MAAM,CAE/F,0BAA0B,CAAE,aAAa,GAAG,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,CAAC,CAAC,CAExD,mBAAmB,CAAE;AACzB,CAEA,0BAAY,MAAO,CAEf,eAAe,CAAE,CAAC,CAElB,gBAAgB,CAAE,IAAI,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,CAAC,CAAC,IAAI,eAAe,CAAC,EAAE,CAAC;AAC/D,CAEA,0BAAY,IAAI,KAAK,CAAC,CAAC,CAAE,CAErB,eAAe,CAAE,CAAC,CAElB,gBAAgB,CAAE,IAAI,EAAE,CAAC,EAAE,CAAC,EAAE,CAAC,CAAC,CAAC,IAAI,eAAe,CAAC,EAAE,CAAC;AAC5D,CAEA,0BAAY,MAAM,IAAI,KAAK,CAAC,CAAC,CAAE,CAE3B,eAAe,CAAE,CAAC,CAElB,gBAAgB,CAAE,IAAI,EAAE,CAAC,EAAE,CAAC,GAAG,CAAC,CAAC,CAAC,IAAI,eAAe,CAAC,EAAE,CAAC;AAC7D,CAEE,0BAAa,CAEX,iBAAiB,CAAE,CAAC,CAEpB,KAAK,CAAE,IAAI,EAAE,CAAC,EAAE,CAAC,EAAE,CAAC,CAAC,CAAC,IAAI,iBAAiB,CAAC,EAAE,CAAC,CAAC,CAEhD,mBAAmB,CAAE,KAAK,CAAC,CAAC,gBAAgB,CAAC,CAAC,YAAY,CAAC,CAAC,qBAAqB,CAAC,CAAC,IAAI,CAAC,CAAC,MAAM,CAE/F,0BAA0B,CAAE,aAAa,GAAG,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,CAAC,CAAC,CAExD,mBAAmB,CAAE;AACzB,CAEE,0BAAY,MAAO,CAEjB,iBAAiB,CAAE,CAAC,CAEpB,KAAK,CAAE,IAAI,EAAE,CAAC,EAAE,CAAC,GAAG,CAAC,CAAC,CAAC,IAAI,iBAAiB,CAAC,EAAE,CAAC;AACpD,CAEE,0BAAY,IAAI,KAAK,CAAC,CAAC,CAAE,CAEvB,iBAAiB,CAAE,CAAC,CAEpB,KAAK,CAAE,IAAI,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,CAAC,CAAC,IAAI,iBAAiB,CAAC,EAAE,CAAC;AACtD,CAEE,0BAAY,MAAM,IAAI,KAAK,CAAC,CAAC,CAAE,CAE7B,iBAAiB,CAAE,CAAC,CAEpB,KAAK,CAAE,IAAI,EAAE,CAAC,GAAG,CAAC,GAAG,CAAC,CAAC,CAAC,IAAI,iBAAiB,CAAC,EAAE,CAAC;AACrD"}'
};
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<footer class="bg-white dark:bg-gray-800 shadow-lg mt-auto"><div class="container mx-auto px-4 py-8"><div class="grid grid-cols-1 md:grid-cols-4 gap-8"> <div class="space-y-4"><div class="flex items-center gap-2">${validate_component(Newspaper, "Newspaper").$$render(
    ...
    {},
    {}
  )} <span class="text-xl font-bold" data-svelte-h="svelte-6z0aod">DiplomMap</span></div> <p class="text-sm text-gray-600 dark:text-gray-400" data-svelte-h="svelte-112hvkt">Your comprehensive source for global news, conflicts, and geopolitical insights.</p> <div class="flex gap-4"><a href="#" class="social-link svelte-b1jbhb">${validate_component(Twitter, "Twitter").$$render($$result, { class: "w-5 h-5" }, {}, {})}</a> <a href="#" class="social-link svelte-b1jbhb">${validate_component(Facebook, "Facebook").$$render($$result, { class: "w-5 h-5" }, {}, {})}</a> <a href="#" class="social-link svelte-b1jbhb">${validate_component(Instagram, "Instagram").$$render($$result, { class: "w-5 h-5" }, {}, {})}</a> <a href="#" class="social-link svelte-b1jbhb">${validate_component(Linkedin, "Linkedin").$$render($$result, { class: "w-5 h-5" }, {}, {})}</a></div></div>  <div data-svelte-h="svelte-gyu99j"><h3 class="font-semibold mb-4">Quick Links</h3> <ul class="space-y-2"><li><a href="#" class="footer-link svelte-b1jbhb">Top Stories</a></li> <li><a href="#" class="footer-link svelte-b1jbhb">Global Conflicts</a></li> <li><a href="#" class="footer-link svelte-b1jbhb">Elections</a></li> <li><a href="#" class="footer-link svelte-b1jbhb">Markets</a></li></ul></div>  <div data-svelte-h="svelte-ya0d93"><h3 class="font-semibold mb-4">Categories</h3> <ul class="space-y-2"><li><a href="#" class="footer-link svelte-b1jbhb">World News</a></li> <li><a href="#" class="footer-link svelte-b1jbhb">India</a></li> <li><a href="#" class="footer-link svelte-b1jbhb">Business</a></li> <li><a href="#" class="footer-link svelte-b1jbhb">Technology</a></li> <li><a href="#" class="footer-link svelte-b1jbhb">Sports</a></li></ul></div>  <div><h3 class="font-semibold mb-4" data-svelte-h="svelte-morqfs">Stay Updated</h3> <p class="text-sm text-gray-600 dark:text-gray-400 mb-4" data-svelte-h="svelte-1cqup2p">Subscribe to our newsletter for daily updates.</p> <div class="flex"><input type="email" placeholder="Enter your email" class="flex-1 px-4 py-2 rounded-l-lg border dark:border-gray-700 bg-gray-50 dark:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500"> <button class="px-4 py-2 bg-blue-600 text-white rounded-r-lg hover:bg-blue-700 transition-colors">${validate_component(Mail, "Mail").$$render($$result, { class: "w-5 h-5" }, {}, {})}</button></div></div></div> <div class="border-t dark:border-gray-700 mt-8 pt-8 text-center text-sm text-gray-600 dark:text-gray-400"><p>© ${escape((/* @__PURE__ */ new Date()).getFullYear())} DiplomMap. All rights reserved.</p></div></div> </footer>`;
});
const css = {
