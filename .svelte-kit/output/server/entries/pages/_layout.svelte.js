...
const css$2 = {
  code: ".nav-link.svelte-231lio{display:flex;align-items:center;gap:0.5rem;--tw-text-opacity:1;color:rgb(75 85 99 / var(--tw-text-opacity))\n}.nav-link.svelte-231lio:hover{--tw-text-opacity:1;color:rgb(37 99 235 / var(--tw-text-opacity))\n}.nav-link.svelte-231lio:is(.dark *){--tw-text-opacity:1;color:rgb(209 213 219 / var(--tw-text-opacity))\n}.nav-link.svelte-231lio:hover:is(.dark *){--tw-text-opacity:1;color:rgb(96 165 250 / var(--tw-text-opacity))\n}.nav-button.svelte-231lio{border-radius:9999px;padding:0.5rem;transition-property:color, background-color, border-color, text-decoration-color, fill, stroke;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);transition-duration:150ms\n}.nav-button.svelte-231lio:hover{--tw-bg-opacity:1;background-color:rgb(243 244 246 / var(--tw-bg-opacity))\n}.nav-button.svelte-231lio:hover:is(.dark *){--tw-bg-opacity:1;background-color:rgb(55 65 81 / var(--tw-bg-opacity))\n}",
  map: `{"version":3,"file":"Navbar.svelte","sources":["Navbar.svelte"],"sourcesContent":["<script lang=\\"ts\\">import { Globe, Sun, Moon, Search, Bell, User, TrendingUp, Newspaper, BarChart2, Bookmark } from \\"lucide-svelte\\";\\nimport { theme } from \\"$lib/stores/theme\\";\\nlet showConflictMap = false;\\nfunction toggleTheme() {\\n  theme.update((t) => t === \\"light\\" ? \\"dark\\" : \\"light\\");\\n}\\n<\/script>\\n\\n<nav class=\\"bg-white dark:bg-gray-800 shadow-lg\\">\\n  <div class=\\"container mx-auto px-4\\">\\n    <div class=\\"flex items-center justify-between h-16\\">\\n      <!-- Logo and Main Nav -->\\n      <div class=\\"flex items-center gap-8\\">\\n        <div class=\\"flex items-center gap-2\\">\\n          <Newspaper class=\\"w-8 h-8 text-blue-600 dark:text-blue-400\\" />\\n          <span class=\\"text-xl font-bold\\">DiplomMap</span>\\n        </div>\\n        \\n        <div class=\\"hidden md:flex items-center gap-6\\">\\n          <a href=\\"/\\" class=\\"nav-link\\">\\n            <TrendingUp class=\\"w-4 h-4\\" />\\n            <span>Top Stories</span>\\n          </a>\\n          <a href=\\"/markets\\" class=\\"nav-link\\">\\n            <BarChart2 class=\\"w-4 h-4\\" />\\n            <span>Markets</span>\\n          </a>\\n          <a href=\\"/saved\\" class=\\"nav-link\\">\\n            <Bookmark class=\\"w-4 h-4\\" />\\n            <span>Saved</span>\\n          </a>\\n          <a\\n            href=\\"/conflicts\\"\\n            class=\\"flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-100 hover:bg-blue-200 dark:hover:bg-blue-800 transition-colors\\"\\n          >\\n            <Globe class=\\"w-4 h-4\\" />\\n            Global Conflicts\\n          </a>\\n        </div>\\n      </div>\\n\\n      <!-- Search Bar -->\\n      <div class=\\"hidden md:flex flex-1 max-w-xl mx-8\\">\\n        <div class=\\"relative w-full\\">\\n          <input\\n            type=\\"text\\"\\n            placeholder=\\"Search news, markets, conflicts...\\"\\n            class=\\"w-full px-4 py-2 pl-10 pr-4 rounded-lg border dark:border-gray-700 bg-gray-50 dark:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500\\"\\n          />\\n          <Search class=\\"absolute left-3 top-2.5 w-5 h-5 text-gray-400\\" />\\n        </div>\\n      </div>\\n\\n      <!-- Right Side Nav -->\\n      <div class=\\"flex items-center gap-4\\">\\n        <button class=\\"nav-button relative\\">\\n          <Bell class=\\"w-5 h-5\\" />\\n          <span class=\\"absolute top-0 right-0 w-2 h-2 bg-red-500 rounded-full\\"></span>\\n        </button>\\n        \\n        <button\\n          class=\\"nav-button\\"\\n          on:click={toggleTheme}\\n        >\\n          {#if $theme === 'light'}\\n            <Moon class=\\"w-5 h-5\\" />\\n          {:else}\\n            <Sun class=\\"w-5 h-5\\" />\\n          {/if}\\n        </button>\\n\\n        <button class=\\"flex items-center gap-2 px-3 py-1.5 rounded-full bg-gray-100 dark:bg-gray-700\\">\\n          <User class=\\"w-5 h-5\\" />\\n          <span class=\\"hidden md:inline\\">Account</span>\\n        </button>\\n      </div>\\n    </div>\\n  </div>\\n</nav>\\n\\n<style lang=\\"postcss\\">\\n  .nav-link {\\n\\n    display: flex;\\n\\n    align-items: center;\\n\\n    gap: 0.5rem;\\n\\n    --tw-text-opacity: 1;\\n\\n    color: rgb(75 85 99 / var(--tw-text-opacity))\\n}\\n\\n.nav-link:hover {\\n\\n    --tw-text-opacity: 1;\\n\\n    color: rgb(37 99 235 / var(--tw-text-opacity))\\n}\\n\\n.nav-link:is(.dark *) {\\n\\n    --tw-text-opacity: 1;\\n\\n    color: rgb(209 213 219 / var(--tw-text-opacity))\\n}\\n\\n.nav-link:hover:is(.dark *) {\\n\\n    --tw-text-opacity: 1;\\n\\n    color: rgb(96 165 250 / var(--tw-text-opacity))\\n}\\n\\n  .nav-button {\\n\\n    border-radius: 9999px;\\n\\n    padding: 0.5rem;\\n\\n    transition-property: color, background-color, border-color, text-decoration-color, fill, stroke;\\n\\n    transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1);\\n\\n    transition-duration: 150ms\\n}\\n\\n  .nav-button:hover {\\n\\n    --tw-bg-opacity: 1;\\n\\n    background-color: rgb(243 244 246 / var(--tw-bg-opacity))\\n}\\n\\n  .nav-button:hover:is(.dark *) {\\n\\n    --tw-bg-opacity: 1;\\n\\n    background-color: rgb(55 65 81 / var(--tw-bg-opacity))\\n}\\n</style>"],"names":[],"mappings":"AAiFE,uBAAU,CAER,OAAO,CAAE,IAAI,CAEb,WAAW,CAAE,MAAM,CAEnB,GAAG,CAAE,MAAM,CAEX,iBAAiB,CAAE,CAAC,CAEpB,KAAK,CAAE,IAAI,EAAE,CAAC,EAAE,CAAC,EAAE,CAAC,CAAC,CAAC,IAAI,iBAAiB,CAAC;AAChD,CAEA,uBAAS,MAAO,CAEZ,iBAAiB,CAAE,CAAC,CAEpB,KAAK,CAAE,IAAI,EAAE,CAAC,EAAE,CAAC,GAAG,CAAC,CAAC,CAAC,IAAI,iBAAiB,CAAC;AACjD,CAEA,uBAAS,IAAI,KAAK,CAAC,CAAC,CAAE,CAElB,iBAAiB,CAAE,CAAC,CAEpB,KAAK,CAAE,IAAI,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,CAAC,CAAC,IAAI,iBAAiB,CAAC;AACnD,CAEA,uBAAS,MAAM,IAAI,KAAK,CAAC,CAAC,CAAE,CAExB,iBAAiB,CAAE,CAAC,CAEpB,KAAK,CAAE,IAAI,EAAE,CAAC,GAAG,CAAC,GAAG,CAAC,CAAC,CAAC,IAAI,iBAAiB,CAAC;AAClD,CAEE,yBAAY,CAEV,aAAa,CAAE,MAAM,CAErB,OAAO,CAAE,MAAM,CAEf,mBAAmB,CAAE,KAAK,CAAC,CAAC,gBAAgB,CAAC,CAAC,YAAY,CAAC,CAAC,qBAAqB,CAAC,CAAC,IAAI,CAAC,CAAC,MAAM,CAE/F,0BAA0B,CAAE,aAAa,GAAG,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,CAAC,CAAC,CAExD,mBAAmB,CAAE;AACzB,CAEE,yBAAW,MAAO,CAEhB,eAAe,CAAE,CAAC,CAElB,gBAAgB,CAAE,IAAI,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,CAAC,CAAC,IAAI,eAAe,CAAC;AAC5D,CAEE,yBAAW,MAAM,IAAI,KAAK,CAAC,CAAC,CAAE,CAE5B,eAAe,CAAE,CAAC,CAElB,gBAAgB,CAAE,IAAI,EAAE,CAAC,EAAE,CAAC,EAAE,CAAC,CAAC,CAAC,IAAI,eAAe,CAAC;AACzD"}`
};
const Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_theme();
  return `<nav class="bg-white dark:bg-gray-800 shadow-lg"><div class="container mx-auto px-4"><div class="flex items-center justify-between h-16"> <div class="flex items-center gap-8"><div class="flex items-center gap-2">${validate_component(Newspaper, "Newspaper").$$render(
    $$result,
    {
    ...
    {},
    {}
  )} <span class="text-xl font-bold" data-svelte-h="svelte-6z0aod">DiplomMap</span></div> <div class="hidden md:flex items-center gap-6"><a href="/" class="nav-link svelte-231lio">${validate_component(Trending_up, "TrendingUp").$$render($$result, { class: "w-4 h-4" }, {}, {})} <span data-svelte-h="svelte-1nh06tc">Top Stories</span></a> <a href="/markets" class="nav-link svelte-231lio">${validate_component(Bar_chart_2, "BarChart2").$$render($$result, { class: "w-4 h-4" }, {}, {})} <span data-svelte-h="svelte-i5z6ph">Markets</span></a> <a href="/saved" class="nav-link svelte-231lio">${validate_component(Bookmark, "Bookmark").$$render($$result, { class: "w-4 h-4" }, {}, {})} <span data-svelte-h="svelte-7f40kr">Saved</span></a> <a href="/conflicts" class="flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-100 hover:bg-blue-200 dark:hover:bg-blue-800 transition-colors">${validate_component(Globe, "Globe").$$render($$result, { class: "w-4 h-4" }, {}, {})}
            Global Conflicts</a></div></div>  <div class="hidden md:flex flex-1 max-w-xl mx-8"><div class="relative w-full"><input type="text" placeholder="Search news, markets, conflicts..." class="w-full px-4 py-2 pl-10 pr-4 rounded-lg border dark:border-gray-700 bg-gray-50 dark:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500"> ${validate_component(Search, "Search").$$render(
    $$result,
    {
    ...
    {},
    {}
  )}</div></div>  <div class="flex items-center gap-4"><button class="nav-button relative svelte-231lio">${validate_component(Bell, "Bell").$$render($$result, { class: "w-5 h-5" }, {}, {})} <span class="absolute top-0 right-0 w-2 h-2 bg-red-500 rounded-full"></span></button> <button class="nav-button svelte-231lio">${$theme === "light" ? `${validate_component(Moon, "Moon").$$render($$result, { class: "w-5 h-5" }, {}, {})}` : `${validate_component(Sun, "Sun").$$render($$result, { class: "w-5 h-5" }, {}, {})}`}</button> <button class="flex items-center gap-2 px-3 py-1.5 rounded-full bg-gray-100 dark:bg-gray-700">${validate_component(User, "User").$$render($$result, { class: "w-5 h-5" }, {}, {})} <span class="hidden md:inline" data-svelte-h="svelte-fb25vy">Account</span></button></div></div></div> </nav>`;
});
const css$1 = {
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  $$unsubscribe_theme();
  return `<div class="${"min-h-screen flex flex-col " + escape($theme, true)}">${validate_component(Navbar, "Navbar").$$render($$result, {}, {}, {})} <main class="flex-1 bg-gray-50 dark:bg-gray-900">${slots.default ? slots.default({}) : ``}</main> ${validate_component(Footer, "Footer").$$render($$result, {}, {}, {})} ${validate_component(Toaster, "Toaster").$$render($$result, {}, {}, {})} </div>`;
});
export {
  Layout as default
};
